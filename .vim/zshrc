...
export ZSH="/home/nshaikh/.oh-my-zsh"
...
export PATH=$HOME/bin:/usr/local/bin:$PATH:/home/nshaikh/go/src/github.com/knative/client:$GOPATH/bin:/usr/local/go/bin:/home/nshaikh/crc/crc-linux-1.6.0-amd64
# explicit setting golang path for tarball install
export PATH=$PATH:/usr/local/golang/bin
export PATH="${KREW_ROOT:-$HOME/.krew}/bin:$PATH"

# serverless/knative dev setup
export KO_DOCKER_REPO='quay.io/navidshaikh'
export DOCKER_REPO_OVERRIDE="quay.io/navidshaikh"
...
if [[ $(minikube status | grep Running | wc -l) == 3 ]]; then
